...
Feature: verify data against management agreement
  ...
  Scenario Outline: verify ascending and descending order of management agreement
    ...
    Examples:
      ...
      |   admin      |  table    |   relation     | UrlLink |
      |   admin      |  table1   |   relation     | UrlLink |
  ...
  Scenario Outline: verify the my site file should be downloaded
    ...
    Examples:
      ...
      |   admin      |   downloadButton   |   relation     | UrlLink |
  ...
  Scenario Outline: view relationship/owner/portfolio for Vb admin
    ...
    Examples:
      ...
      |   admin    |  reportsKPI |  reports  |    relation    | UrlLink |
  ...
  Scenario Outline: verify dropdown for relationship/owner/portfolio
    ...
    Examples:
      ...
      |   admin    | rolesPermission| portfolioType | relationship1 | relationshipRole1 |  realEstateUser  |reportsKPI|reports| UrlLink |
#      |   admin    | rolesPermission| portfolioType | relationship2 | relationshipRole2 |  realEstateUser  |reportsKPI|reports| UrlLink |
#      |   admin    | rolesPermission| portfolioType | relationship  | relationshipRole  |  realEstateUser  |reportsKPI|reports| UrlLink |
  ...
  Scenario Outline: verify external user should access data for portfolio
    ...
    Examples:
         ...
         |    realEstateUser    |  reportsKPI  |   reports  | externalUser  | UrlLink |
#         |  utilityPartnerUser  |  reportsKPI  |   reports  | externalUser  | UrlLink |
#         |  jvPartnerUser      |   reportsKPI  |   reports  | externalUser  | UrlLink |
  ...
  Scenario Outline: verify internal user should access data for portfolio
    ...
    Examples:
      ...
      |rolesPermission  |    realEstateUser     |     admin        | portfolioType | reportsKPI  |   reports  | UrlLink |
#      |rolesPermission1 |  utilityPartnerUser   |     admin        | portfolioType | reportsKPI  |   reports  | UrlLink |
#      |rolesPermission2 |     jvPartnerUser     |     admin        | portfolioType | reportsKPI  |   reports  | UrlLink |